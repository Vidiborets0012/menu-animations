...
const menuButtonSeven = document.querySelector('.menu-btn-seven');
const menuSeven = document.querySelector('.menu-seven');

menuButtonSeven.addEventListener('click', () => {
    
    menuButtonSeven.classList.toggle('active');
    menuSeven.classList.toggle('active');
...
const menuButtonEight = document.querySelector('.menu-btn-eight');
const menuEight = document.querySelector('.menu-eight');

menuButtonEight.addEventListener('click', () => {
    
    menuButtonEight.classList.toggle('active');
    menuEight.classList.toggle('active');
...
const menuButtonTen = document.querySelector('.menu-btn-ten');
const menuTen = document.querySelector('.menu-ten');

menuButtonTen.addEventListener('click', () => {
    
    menuButtonTen.classList.toggle('active');
    menuTen.classList.toggle('active');
